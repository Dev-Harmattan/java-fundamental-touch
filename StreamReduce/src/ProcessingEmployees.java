...
public class ProcessingEmployees {
   public static void main(String[] args){
      ...
      Optional<Employee> result = Optional.of(list.stream()
         .filter(fourToSixThousand)
         .findFirst()
         .get());

      if(result.isPresent()){
         System.out.printf("%nFirst employee who earns $4000-$6000:%n%s%n", result.get());
      }
      ...
      groupByDepartment
         .forEach((department, employeeInDepartment) -> {
